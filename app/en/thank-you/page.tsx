      ...
      <div className="max-w-2xl w-full space-y-8 animate-fade-in">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 pt-10 border-t border-[var(--foreground)]/10">
          <div className="flex flex-col items-center gap-2">
            ...
            <span className="text-[10px] uppercase tracking-widest font-mono opacity-50">Stay</span>
            <span className="text-sm font-medium">Check Email</span>
          </div>
          <div className="flex flex-col items-center gap-2">
            <MapPin className="text-primary opacity-60" size={20} />
            <span className="text-[10px] uppercase tracking-widest font-mono opacity-50">Address</span>
